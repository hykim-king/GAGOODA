...
public class RefundDto {
    ...
    private int orderId;            // order_id, FK, NN ( REFUND : ORDER ) 1:1
    private int orderDetailId;      // order_detail_id, FK, NN, ( REFUND : ORDER_DTEAIL ) 1:1
    private int addressId;          // address_id, FK, NN ( REFUND : ADDRESS ) 1:1
    private int cancelAmount;       // cancel_amount
    private String productId;       // product_id, FK, NN, ( REFUND : PRODUCT ) 1:N
